...
<html>
    ...
    <body>
              ...
              <div class="mdl-cell">
                <!--   Main page content here:   -->
                  ...
                  <!-- Textfield: Location -->
                    ...
                    <form action="#">
                      <div class="mdl-textfield mdl-js-textfield" id='locatio'>
        ...
        <!--   JavaScript files:   -->
         ...
         <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDLmXk13cnSawSePqGi88GsbaVBuNCR34g&callback=initMap">
    </script>
